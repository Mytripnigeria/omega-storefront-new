...
export const BottomNav = ({ onCartClick, onWalletClick, onSignInClick, isLoggedIn }: BottomNavProps) => {
  ...
  return (
    <div className="fixed bottom-0 inset-x-0 z-40 px-4 pb-6 pt-3 pointer-events-none lg:hidden ios-layer">
      <div className="max-w-lg mx-auto">
        <div className="flex items-center gap-2">
          ...
          <motion.button
            ...
            className={cn(
              "flex-1 h-14 rounded-full font-bold text-base flex items-center justify-between px-6 transition-all shadow-none pointer-events-auto",
